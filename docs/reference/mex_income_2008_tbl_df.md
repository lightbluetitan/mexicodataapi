...
This dataset, mex_income_2008_tbl_df, is a tibble containing
household-level income data and associated demographic characteristics
from the 2008 ENIGH (Household Income and Expenditure Survey) in Mexico.
...
The dataset name has been kept as 'mex_income_2008_tbl_df' to avoid
