...
The `MexicoDataAPI` package provides several core functions to access real-time and structured information about Mexico from public APIs such as the [World Bank API](https://api.worldbank.org/v2/) and [REST Countries](https://restcountries.com/). 
